"""
Django settings for jade_distro_prd_sam_44869 project.
...
ROOT_URLCONF = 'jade_distro_prd_sam_44869.urls'
...
WSGI_APPLICATION = 'jade_distro_prd_sam_44869.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jade_distro_prd_sam_44869 API",
    "DESCRIPTION": "API documentation for jade_distro_prd_sam_44869 App",
    "VERSION": "v1",
}
